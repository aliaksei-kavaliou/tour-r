...
}, 4)))->createTransport('enqueue://sqs?receiveTimeout=1000&queue[name]='.$this->getEnv('string:resolve:IMPORTER_SQS_QUEUE').'&topic[name]='.$this->getEnv('string:resolve:IMPORTER_SQS_QUEUE'), [], new \Symfony\Component\Messenger\Transport\Serialization\Serializer(($this->services['serializer'] ?? $this->load('getSerializerService.php')), 'json', []));
