...
return $this->services['cache_warmer'] = new \Symfony\Component\HttpKernel\CacheWarmer\CacheWarmerAggregate(new RewindableGenerator(function () {
    ...
    yield 2 => ($this->privates['serializer.mapping.cache_warmer'] ?? ($this->privates['serializer.mapping.cache_warmer'] = new \Symfony\Bundle\FrameworkBundle\CacheWarmer\SerializerCacheWarmer([], ($this->targetDirs[0].'/serialization.php'))));
